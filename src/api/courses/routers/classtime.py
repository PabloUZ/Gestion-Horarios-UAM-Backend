...
@classtime_router.post('',response_model=dict,description="Creates a new classtime")
...
@classtime_router.put('/{id}', tags=['classtimes'], response_model=dict, description="Updates the data of specific classtime") 
