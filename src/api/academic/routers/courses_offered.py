...
@router.post("/", response_model=CoursesOffered, description="Create a new course offered")
...
@router.put("/{course_offered_id}", response_model=CoursesOffered, description="Update a course Offered by id")
...
@router.delete("/{course_offered_id}",response_model=dict, description="Delete a course Offered by id")
