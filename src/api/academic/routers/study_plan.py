...
@router.post("/", dependencies=[Depends(HasPermission("CREATE_STUDY_PLAN"))] ,response_model=StudyPlan, description="Create a new study plan")
...
@router.put("/{study_plan_id}", dependencies=[Depends(HasPermission("UPDATE_STUDY_PLAN"))] , response_model=StudyPlan, description="Update a study plan by id")
...
@router.delete("/{study_plan_id}",dependencies=[Depends(HasPermission("DELETE_STUDY_PLAN"))] , response_model=dict, description="Delete a study plan by id")
