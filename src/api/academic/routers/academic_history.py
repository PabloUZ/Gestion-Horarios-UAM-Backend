...
@router.get("/{academic_history_id}", response_model=AcademicHistory, description="Get a academic history by id")
...
@router.post("/", response_model=AcademicHistory, description="Create a new academic history")
...
@router.put("/{academic_history_id}", response_model=AcademicHistory, description="Update a academic history by id")
...
@router.delete("/{academic_history_id}",response_model=dict, description="Delete a academic history by id")
